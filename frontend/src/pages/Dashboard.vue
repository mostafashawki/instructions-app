<template>
  <div :class="$q.screen.lt.md ? 'container-mobile' : 'container-desktop'">
    <div>
      ...
      <div class="row">
        <div class="col-12 col-xl-6 q-pb-md" :class="!$q.screen.lt.xl ? 'q-pr-md' : ''">
        ...
        <div class="col-12 col-xl-6 q-pb-md" :class="!$q.screen.lt.xl ? 'q-pl-md' : ''">
          <q-card v-if="query" flat>
            <h2 class="font-mn-black q-my-none q-pt-md q-pl-md">Something</h2>
          </q-card>
        </div>
      </div>
    </div>
